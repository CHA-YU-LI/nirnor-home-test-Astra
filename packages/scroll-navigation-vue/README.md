# 慣性捲動、黏附目錄與導覽換色 — Vue 範例

## 啟動

1. 完整解壓縮，用 VS Code 開啟 scroll-navigation-vue 資料夾（內有 package.json）。
...
- src/demos/scroll-navigation/effect.js：效果邏輯。
- src/demos/scroll-navigation/effect.scss：效果樣式，Vite 自動编譯。
