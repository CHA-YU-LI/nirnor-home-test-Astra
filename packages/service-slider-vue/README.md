...
1. 完整解壓縮，用 VS Code 開啟 service-slider-vue 資料夾（內有 package.json）。
...
- src/demos/service-slider/effect.js：效果邏輯。
- src/demos/service-slider/effect.scss：效果樣式，Vite 自動编譯。
- src/scss/：完整共用 Sass 相依。
- src/assets/motion-study.webm：可替換的展示影片。
