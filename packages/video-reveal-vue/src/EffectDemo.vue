...
import { init } from './demos/video-reveal/effect.js';
import { options } from './options.js';
import sourceMarkup from './effect.html?raw';
import './demos/video-reveal/effect.scss';
import videoUrl from './assets/motion-study.webm';

// This HTML is a trusted local source file, never user-submitted content.
const markup = sourceMarkup.replaceAll('./assets/motion-study.webm', videoUrl);
const host = ref(null);
...
// To update parameters at runtime: effect.update({ speed: 1 });
