...
1. 完整解壓縮，用 VS Code 開啟 page-transition-vue 資料夾（內有 package.json）。
...
- src/demos/page-transition/effect.js：效果邏輯。
- src/demos/page-transition/effect.scss：效果樣式，Vite 自動编譯。
