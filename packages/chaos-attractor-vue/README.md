...
1. 完整解壓縮，用 VS Code 開啟 chaos-attractor-vue 資料夾（內有 package.json）。
...
- src/demos/chaos-attractor/effect.js：效果邏輯。
- src/demos/chaos-attractor/effect.scss：效果樣式，Vite 自動编譯。
